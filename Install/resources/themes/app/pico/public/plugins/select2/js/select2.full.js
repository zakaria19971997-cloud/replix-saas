...
S2.define('select2/core',[
  ...
  Select2.prototype._syncContainerWidth = function () {
  ...
  Select2.prototype._registerDomEvents = function () {
    ...
    this._syncWidth = Utils.bind(this._syncContainerWidth, this);
    this._resizeNamespace = '.select2.' + this.id;
  ...
  Select2.prototype.destroy = function () {
    if (this._resizeNamespace) {
      $(window).off('resize' + this._resizeNamespace);
      this._resizeNamespace = null;
    }
