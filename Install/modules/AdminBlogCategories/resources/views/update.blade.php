<div class="modal fade" id="BlogCategoriesModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<form class="modal-content actionForm" action="{{ module_url("save") }}" data-call-success="Main.closeModal('BlogCategoriesModal'); Main.ajaxScroll(true);">
			<div class="modal-header">
				<h1 class="modal-title fs-16">{{ __("Create Blog Categories") }}</h1>
 				...
 				<div class="row">
 					...
 					<div class="col-md-12">
 						<div class="mb-4">
	                     	...
	                     	<input placeholder="{{ __('Enter Category Name') }}" class="form-control" name="name" id="name" type="text" value="{{ data($result, "name") }}">
		                </div>
 					</div>
                    <div class="col-md-12">
 						<div class="mb-4">
		                  	<label for="desc" class="form-label">{{ __('Description') }}</label>
	                     	<input placeholder="{{ __('Short description') }}" class="form-control" name="desc" id="desc" type="text" value="{{ data($result, "desc") }}">
		                </div>
 					</div>
 					<div class="col-md-12">
 						<div class="mb-4">
		                  	<label for="name" class="form-label">{{ __('Icon') }}</label>
		                  	<div class="text-gray-600 fs-12 mb-2">{{ __("You can find icon at here: ") }}<a href="https://fontawesome.com/search" target="_blank">https://fontawesome.com/search</a></div>
