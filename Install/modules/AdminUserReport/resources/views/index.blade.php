...
@section('sub_header')
    <x-sub-header 
        ...
        description="{{ __('Overview of user activity, insights, and reports.') }}" 
    >
        <a  href="{{ route("admin.users.report.export_pdf") }}" class="btn btn-dark exportPDF">{{ __("Export PDF") }}</a>
    </x-sub-header>
@endsection
...
<div class="container pb-5">
        ...
        <div class="ajax-pages" data-url="{{ route('admin.users.report.statistics') }}" data-resp=".ajax-pages">
