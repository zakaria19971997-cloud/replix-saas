...
@if($status === 'success')
    <div class="d-flex flex-column gap-20 hp-100">
                                ...
                                <div class="border rounded-3 p-3 p-lg-4 hp-100 {{ !empty($result?->id_secure) && $result->id_secure === $item->id_secure ? 'border-primary bg-primary-100' : 'bg-white' }}">
                                    <div class="d-flex justify-content-between align-items-start gap-12 mb-3">
                                        ...
                                        <div class="d-flex gap-8 flex-shrink-0">
                                            <button type="button" class="btn btn-outline btn-dark btn-sm wa-chatbot-edit" data-id="{{ $item->id_secure }}">
                                                <i class="fa-light fa-pen"></i>
                                            </button>
                                            <button type="button" class="btn btn-outline btn-dark btn-sm wa-chatbot-delete" data-url="{{ route('app.whatsappchatbot.delete', ['id_secure' => $item->id_secure]) }}">
        ...
        <form id="WhatsAppChatbotForm" action="{{ route('app.whatsappchatbot.save') }}" method="POST" class="actionForm card shadow-none border-gray-300 overflow-hidden">
            @csrf
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="border rounded-3 overflow-hidden bg-white">
                            ...
                            <div class="p-4 p-xl-5">
                                <div class="d-flex align-items-start gap-12 px-3 px-lg-4 py-3 rounded-3 bg-primary-100 text-gray-700 mb-4">
                                ...
                                <div class="mb-3 wrap-input-emoji">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center overflow-x-auto border border-top-0 bbr-r-6 bbl-r-6 bg-white">
                                        ...
                                        <div class="px-3 fs-12 text-gray-500 text-nowrap">
                                            {{ __('Use AI, saved captions, and media from the left panel.') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
