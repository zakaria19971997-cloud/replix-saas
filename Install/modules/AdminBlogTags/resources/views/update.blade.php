<div class="modal fade" id="BlogTagsModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<form class="modal-content actionForm" action="{{ module_url("save") }}" data-call-success="Main.closeModal('BlogTagsModal'); Main.DataTable_Reload('#DataTable'); Main.ajaxScroll(true);">
			<div class="modal-header">
				<h1 class="modal-title fs-16">{{ __("Create Blog Tag") }}</h1>
 				...
 				<div class="row">
 					...
 					<div class="col-md-12">
 						<div class="mb-4">
	                     	...
	                     	<input placeholder="{{ __('Enter Tag Name') }}" class="form-control" name="name" id="name" type="text" value="{{ data($result, "name") }}">
		                </div>
 					</div>
                    <div class="col-md-12">
 						<div class="mb-4">
		                  	<label for="desc" class="form-label">{{ __('Description') }}</label>
	                     	<input placeholder="{{ __('Enter short description') }}" class="form-control" name="desc" id="desc" type="text" value="{{ data($result, "desc") }}">
		                </div>
 					</div>
 					<div class="col-md-12">
 						<div class="mb-0">
