...
@section('sub_header')
    <x-sub-header
        title="{{ __('Support Categories') }}"
        description="{{ __('Organize and manage support topics systematically for efficiency') }}"
        :count="Number::format($total)"
    >
        <div class="d-flex gap-8">
            <a class="btn btn-dark btn-sm actionItem text-nowrap" href="{{ module_url("update") }}" data-popup="supportCategoryModal" data-bs-target="#staticBackdrop">
