...
<div class="fw-bold fs-20 pb-4 pt-5">{{ __("Payment Stats") }}</div>
...
<script>
	const incomeChart = {!! json_encode($incomeChart) !!};
    ...
    const gatewayChart = {!! json_encode($gatewayChart) !!};
	...
	const planChartSeries = {!! json_encode($planChartSeries) !!};
	const planNames = {!! json_encode($planNames) !!};
